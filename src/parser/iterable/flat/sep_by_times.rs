...
/// A iterable parser generated from method [`flat_sep_by_times`].
///
/// [`flat_sep_by_times`]: crate::parser::iterable::IterableParserExt::flat_sep_by_times
...
impl<P, Q, I> IterableParser<I> for FlatSepByTimes<P, Q>
where
    P: IterableParser<I>,
    Q: Parser<I>,
    I: Positioned + ?Sized,
