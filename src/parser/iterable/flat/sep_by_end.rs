...
/// A iterable parser generated from method [`flat_sep_by_end`].
///
/// [`flat_sep_by_end`]: crate::parser::iterable::IterableParserExt::flat_sep_by_end
...
crate::parser_state! {
    pub struct FlatSepByEndState<I: Input, P: IterableParser, Q: Parser> {
...
impl<P, Q, R, I> IterableParser<I> for FlatSepByEnd<P, Q, R>
where
    P: IterableParser<I>,
    Q: Parser<I>,
    R: RangeBounds<usize>,
