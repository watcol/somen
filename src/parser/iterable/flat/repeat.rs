...
/// A iterable parser generated from method [`flat_repeat`].
///
/// [`flat_repeat`]: crate::parser::iterable::IterableParserExt::flat_repeat
...
crate::parser_state! {
    pub struct FlatRepeatState<I: Input, P: IterableParser> {
        inner: P::State,
...
impl<P, R, I> IterableParser<I> for FlatRepeat<P, R>
where
    P: IterableParser<I>,
    R: RangeBounds<usize>,
    I: Input + ?Sized,
